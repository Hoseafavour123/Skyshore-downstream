...
import { about2, engineer_2 } from '../assets/images'
...
const partnersLogos = [nnpc, lng, mobill, chevron, total, shell, lubric]
    ...
    <div className="font-poppins">
      ...
      <div className="container mx-auto flex gap-5 mb-20 max-md:md:flex-col max-md:flex-col-reverse max-md:p-4">
        <div className="flex-1">
          <img src={about2} alt="" className="h-full" />
        </div>
        <div className="flex-1">
          <p className="font-semibold text-blue-500">Driving excellence in </p>
          ...
          <p className="mt-3">
            ...
            oil and gas industry, renowned for its extensive markets and robust
            distribution networks. SDM operates across Nigeria and extends its
            reach into several West African countries, ensuring efficient
            delivery of petroleum products throughout the region. With a team of
            highly skilled professionals trained as experts in oil and gas
            trading, SDM guarantees excellence and reliability in all its
            operations.
            <br />
            The company’s strong distribution network ensures seamless
            accessibility to energy products, catering to diverse market demands
            across Nigeria and West Africa. Through Skyshore Retail Ltd, SDM
            also operates as an independent petroleum product marketer,
            collaborating with the Nigerian National Petroleum Corporation
            (NNPC) to further its commitment to providing quality energy
            solutions. SDM remains dedicated to driving growth and
      ...
      <div className="bg-black mb-20 md:p-5 max-md:p-3">
        <div className="container mx-auto text-white">
          ...
          <p className="max-md:text-3xl text-5xl font-semibold uppercase">World-Class</p>
          <p className="max-md:text-2xl text-4xl text-blue-500 mt-3 uppercase">
            Downstream products
          </p>
        </div>
        <div className="container md:mx-[85px] md:w-[40%] mt-5">
      ...
      <div className="mt-10 py-10 max-md:p-2 mb-10">
        <div className="flex items-center justify-center mb-8">
          <hr className="w-1/3 border-t-3 border-blue-600" />
